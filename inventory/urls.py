...
urlpatterns = [ 
    ...
    path('filter_for_suplier/', views_suplier.filter_suplier,name='filter_suplier'),
    path('<int:suplier_id>/filter_for_suplier', views_suplier.filter_for_suplier, name='filter_for_suplier'),
    ...
    path('filter_for_category/', views_category.filter_category, name='filter_category'),
